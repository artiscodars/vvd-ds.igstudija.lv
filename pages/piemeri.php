        ...
        <div class="row">
            <div class="col">
                <p>Šajā sadaļā ir attēloti dažu sistēmas sadaļu provizorisie saskarņu izkārtojumi, lai pārbaudītu izmantoto komponenšu pielietojumu.</p>
               
                <h2>Vadības sistēmas saskarņu piemēri</h2>
                <div class="row d-flex align-items-stretch ds-sadalas">
                    ...
                    <h2>Publiskās sistēmas "TULPE" saskarņu piemēri</h2>
                    <div class="row d-flex align-items-stretch ds-sadalas">
